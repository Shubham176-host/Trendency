...
public class AdminNewOrdersActivity extends AppCompatActivity
{
    ...
    {
        public TextView userName, userPhoneNumber, userTotalPrice, userDateTime, userShippingAddress,userpaymentstate, userproductid, userSize;
        ...
        public AdminOrdersViewHolder(View itemView)
        {
            ...
            userpaymentstate= itemView.findViewById(R.id.order_payement_state);
