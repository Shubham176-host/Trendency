...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profileChangeTextBtn = (TextView) findViewById(R.id.profile_image_change_settings_btn);
        closeTextBtn = (TextView) findViewById(R.id.close_settings_btn);
        saveTextBtn = (TextView) findViewById(R.id.update_account_settings_btn);
        //switchdark = (Switch) findViewById(R.id.switch_to_dark);
        ...
        profileChangeTextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view)
            {
                ...
                Toast.makeText(SettingsActivity.this, "Use a Image below 140kb", Toast.LENGTH_SHORT).show();
                Toast.makeText(SettingsActivity.this, "Bigger file can lead to app crash", Toast.LENGTH_SHORT).show();
                checker = "clicked";
